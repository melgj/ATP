...
write_csv(sr_current, "atp_Hard_SR_ratings_jan21.csv")
...
ggplot(temp,
  ...
  labs(title = "Hard Court ATP Player Ratings Through Time - Current Top 20 Rated Players (Stephenson ELO Variant)", 
       x = "Time", y = "Rating") +
